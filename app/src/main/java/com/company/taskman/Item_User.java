...
public class Item_User extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        theme=findViewById(R.id.theme_user_item);
        desc=findViewById(R.id.desc_user_item);
        status=findViewById(R.id.status_user_item);
        update=findViewById(R.id.update_user_item);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.child("task").child(id_from_intent).exists()){
                    ...
                    Toast.makeText(Item_User.this, "Таска не существует", Toast.LENGTH_SHORT).show();
                }
            }
